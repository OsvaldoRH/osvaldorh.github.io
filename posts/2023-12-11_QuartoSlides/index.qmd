...
#### La salida
La salida de este código será una presentación en formato ```html``` la cual tiene su propio sistema de navegación y un pizarrón. Si usas un 'Ipad', puedes utilizar un 'pencil' y escribir en tus diapositivas.  Aquí la salida:
...
Aquí la salida de beamer

{{< pdf slides/_slides.pdf width=100% height=400 >}}

O bien, si prefieres un Powerpoint

```quarto render archivo.qmd --to pptx```

Creo que lejos de ser el final de beamer, Quarto facilita mucho las cosas para generarlos. Claro, las salidas pueden ser personalizadas pero eso es otra historia. 
